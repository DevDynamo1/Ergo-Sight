...
class Deviation:
    ...
    def __init__(self, threshold=40, max_buffer=0):
        ...
        :param max_buffer: Buffer (in terms of deviations) to allow before a deviation is warned.
        """
    ...
    def has_deviated(self):
        """
        :return: True -> current deviation is above the threshold, False otherwise.
        """
