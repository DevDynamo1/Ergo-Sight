...
class Bottleneck(nn.Module):
    ...
    # Defines the forward pass:how input data should be processed through the Bottleneck block to produce an output tensor
    def forward(self, x):
        residual = x
...
class Hourglass(nn.Module):
    ...
    #  Constructs the hourglass network 
